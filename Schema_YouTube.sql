...
CREATE TABLE `comment_reactions` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `comment_reactions_ibfk_1` FOREIGN KEY (`id_comment`) REFERENCES `comments` (`id_comment`),
  CONSTRAINT `comment_reactions_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`)
...
INSERT INTO `comment_reactions` VALUES (1,2,'like','2025-03-01 12:30:00'),(2,1,'dislike','2025-02-18 14:05:00');
...
INSERT INTO `tags` VALUES (3,'Comedy'),(2,'Education'),(1,'Music'),(4,'Sports');
...
CREATE TABLE `video_reactions` (
  ...
  UNIQUE KEY `unique_user_video_reaction` (`id_video`,`id_user`),
  KEY `id_user` (`id_user`),
...
CREATE TABLE `video_tags` (
  ...
  KEY `id_tag` (`id_tag`),
  CONSTRAINT `video_tags_ibfk_1` FOREIGN KEY (`id_video`) REFERENCES `videos` (`id_video`),
  CONSTRAINT `video_tags_ibfk_2` FOREIGN KEY (`id_tag`) REFERENCES `tags` (`id_tag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `video_tags` VALUES (1,1),(1,2),(2,3),(2,4);
...
-- Dump completed on 2025-04-01 14:02:19
